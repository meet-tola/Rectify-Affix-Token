...
<head>
  ...
  <title>Rectify Affix Token - Buy & Sell Digital Assets In The Rectify Affix Token</title>
...
<body>
  ...
  <header class="header" data-header>
    <div class="container">
      ...
      <a href="#" class="logo">
        <img src="./assets/images/logo.svg" width="32" height="32" alt="Rectify Affix Token logo">
        Rectify Affix Token
      </a>
      ...
      <section class="section hero" aria-label="hero" data-section>
        <div class="container">
          ...
          <div class="hero-content">
            ...
            <h1 class="h1 hero-title">Buy & Sell Digital Assets In The Rectify Affix Token</h1>

            <p class="hero-text">
              Rectify Affix Token is a decentralized protocol and platform that combines Blockchain and DeFi, implementing elements from Blockchain with non-custodial management, Micropools, instant liquidity and decentralized governance. 
            </p>
        ...
        <div class="container">
          ...
          <div class="trend-tab">
            ...
            <ul class="tab-nav">
              ...
              <li>
                <button class="tab-btn active">Make your selection below</button>
              </li>
            </ul>
            <ul class="tab-content">
              ...
              <li>
                <div class="trend-card">
                    <a href="#" class="card-value">BUYING</a>
                </div>
              </li>

              <li>
                <div class="trend-card">
                    <a href="#" class="card-value">STAKING</a>
                </div>
              </li>

              <li>
                <div class="trend-card">
                    <a href="#" class="card-value">RECTIFY</a>
                </div>
              </li>

              <li>
                <div class="trend-card">
                    <a href="#" class="card-value">CLAIMING REWARDS</a>
                </div>
              </li>

              <li>
                <div class="trend-card">
                    <a href="#" class="card-value">RECOVERY</a>
                </div>
              </li>

              <li>
                <div class="trend-card">
                    <a href="#" class="card-value">SELLING</a>
                </div>
              </li>

              <li>
                <div class="trend-card">
                    <a href="#" class="card-value">NFT</a>
                </div>
              </li>

              <li>
                <div class="trend-card">
                    <a href="#" class="card-value">WHITELIST</a>
                </div>
              </li>

              <li>
                <div class="trend-card">
                    <a href="#" class="card-value">MIGRATION</a>
                </div>
              </li>

              <li>
                <div class="trend-card">
                    <a href="#" class="card-value">VALIDATION</a>
                </div>
              </li>

              <li>
                <div class="trend-card">
                    <a href="#" class="card-value">AIRDROP</a>
                </div>
              </li>

              <li>
                <div class="trend-card">
                    <a href="#" class="card-value">BRIDGE</a>
                </div>
              </li>

              <li>
                <div class="trend-card">
                    <a href="#" class="card-value">REPLACEMENT</a>
                </div>
              </li>

              <li>
                <div class="trend-card">
                    <a href="#" class="card-value">ADD TOKEN</a>
                </div>
              </li>
      ...
      <section class="section about" aria-label="about" data-section>
        <div class="container">
          ...
          <div class="about-content">
            ...
            <h2 class="h2 section-title">What Is Rectify Affix Token</h2>
  ...
  <footer class="footer">
    ...
    <div class="footer-bottom">
      <div class="container">
        ...
        <p class="copyright">
          Copyright Rectify Affix Token 2023. All rights reserved.
        </p>
